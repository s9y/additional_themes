...
@define('MIMBO_CAT_X1','Select first column category');
@define('MIMBO_CAT_X2','Select second column category');
@define('MIMBO_CAT_X3','Select third column category');
...
@define('FOOTER_SLOGAN','Slogan for the footer');
@define('NEWSPAPER_MODE','Newspaper mode');
@define('SIDEBAR_TITLE','Sidebars: (please do not change!)');
@define('ENABLE_SOLGAN','Enable slogan in footer');