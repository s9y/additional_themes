    ...
    <div class="serendipity_Entry_Date">
        ...
        <div class="serendipity_entry serendipity_entry_author_{$entry.author|@makeFilename} {if $entry.is_entry_owner}serendipity_entry_author_self{/if}">
            ...
            <div class='serendipity_entryFooter'>
                ...
                {if $entry.categories}
                   {$CONST.IN} {foreach from=$entry.categories item="category" name="categories"}<img src='{serendipity_getFile file="img/arrow_right-01.png"}' alt="" /> <a href="{$category.category_link}">{$category.category_name|@escape}</a>{if not $smarty.foreach.categories.last}, {/if}{/foreach}
                {/if}
